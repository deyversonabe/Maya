...
- Checklist da Nara antes do PDF para bloquear valor original, acrescimo, percentual, prazo, validade, condicoes e texto generico.
- CRM separado da Agenda: contato sem conversa fica como lista telefonica; so entra no CRM quando houver historico real.
