...
export async function exportFinanceReportPdf(report: FinanceReport) {
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      ["Resultado do periodo", formatCurrency(report.summary.periodResult)],
      ["Saldo atual", formatCurrency(report.summary.currentBalance)],
      ["Saldo apos contas", formatCurrency(report.summary.projectedBalance)],
...
function summaryRows(report: FinanceReport) {
  return [
    ...
    { Indicador: "Resultado do periodo", Valor: report.summary.periodResult },
    { Indicador: "Saldo atual", Valor: report.summary.currentBalance },
    { Indicador: "Saldo apos contas", Valor: report.summary.projectedBalance },
