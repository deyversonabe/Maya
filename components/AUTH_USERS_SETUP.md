...
O script `scripts/create-supabase-auth-users.mjs` cria ou atualiza os usuarios pelo Supabase Admin API.
...
Se um usuario ja existir, o script atualiza os metadados e mantem a senha atual. Para tambem trocar a senha existente, rode antes:
...
5. Use a mesma conta no celular e no computador para ver os mesmos dados.
