...
2. Sistema usa e-mail como login tecnico e nome de exibicao para identificar pessoas como Deyveron e Tom.
3. Senhas iniciais nao sao armazenadas no repositorio.
4. Recuperacao de senha e iniciada pelo painel do Supabase.
5. Conta administradora usa `deyversonsilvaf@gmail.com` como e-mail de recuperacao administrativa.
