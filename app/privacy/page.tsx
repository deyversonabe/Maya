      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Imagens de comprovantes nao devem ser persistidas nesta etapa; apenas dados revisados e confirmados devem virar lancamentos financeiros."
          ]
        },
        {
          title: "Contato",
          paragraphs: [
            "Para duvidas sobre privacidade, exclusao de dados ou suporte, entre em contato pelo e-mail: mayajuntosia@gmail.com."
          ]
        }
      ]}
    />
