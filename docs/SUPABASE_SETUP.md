...
- A migration `20260816_cloud_storage_hardening.sql` deve ser a ultima executada na sequencia atual; ela consolida lock otimista, tombstones, merge por registro mais recente e preservacao de anexos/dados fiscais.
