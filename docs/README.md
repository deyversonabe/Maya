...
A stack alvo definida pelo Prompt Mestre e Next.js, React, TypeScript, TailwindCSS, shadcn/ui, Framer Motion, Supabase, PostgreSQL gerenciado pelo Supabase, Vercel, GitHub e OpenAI API.
